...
public class CalculatorService {
    ...
    public BigDecimal calculate(int kwota, int liczba_rat, int suma_odsetek, double Rata_kapitalowa_techniczna) {
        int oprocentowanie_roczne = 23;
        Rata_kapitalowa_techniczna = (double) kwota / liczba_rat;
