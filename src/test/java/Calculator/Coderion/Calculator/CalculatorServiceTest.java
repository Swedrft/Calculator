...
public class CalculatorServiceTest {
    ...
    public void testCalculatePoDniu21() {
        ...
        assertEquals(49, raty.get(0).getIloscDni());

        assertEquals(2, raty.get(1).getNumerRaty());
        assertEquals(LocalDate.of(2025, 6, 10), raty.get(1).getTerminPlatnosci());
        assertEquals(31, raty.get(1).getIloscDni());

        assertEquals(3, raty.get(2).getNumerRaty());
        assertEquals(LocalDate.of(2025, 7, 10), raty.get(2).getTerminPlatnosci());
        assertEquals(30, raty.get(2).getIloscDni());

        assertEquals(4, raty.get(3).getNumerRaty());
        assertEquals(LocalDate.of(2025, 8, 10), raty.get(3).getTerminPlatnosci());
        assertEquals(31, raty.get(3).getIloscDni());

        assertEquals(5, raty.get(4).getNumerRaty());
        assertEquals(LocalDate.of(2025, 9, 10), raty.get(4).getTerminPlatnosci());
        assertEquals(31, raty.get(4).getIloscDni());

        assertEquals(6, raty.get(5).getNumerRaty());
        assertEquals(LocalDate.of(2025, 10, 10), raty.get(5).getTerminPlatnosci());
        assertEquals(30, raty.get(5).getIloscDni());
    }
